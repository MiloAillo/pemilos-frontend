...
const AdminChart = ({
  ...
  return (
    <Card className="w-full md:flex-1 flex flex-col bg-gradient-to-br from-neutral-600/30 to-neutral-700/20 border-white/10 shadow-xl">
      <CardTitle className="text-center text-lg md:text-xl font-bold tracking-wide text-white/90 pt-2">
        Live Count Voting {titleChart}
      </CardTitle>
      <CardContent className="flex-1">
        <div className="relative w-full h-64 sm:h-72 md:h-auto md:aspect-[16/9] min-h-0">
          <Bar
            options={{
